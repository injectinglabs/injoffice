...
- The client formula bridge still delegates dependency evaluation, arrays and
  ...
  but the 142-function gate remains curated coverage rather than complete semantic or performance coverage.
...
6. Add interoperable fixture corpora generated by other producers and independent OOXML libraries.
7. Stabilize package APIs toward 1.0 with migration notes and compatibility guarantees.
8. Close the explicitly tracked editor-compatibility gaps; do not claim blanket compatibility until durable UI, model, file, collaboration, and server
