...
[Workbook-backed stacked charts](PPTX-WORKBOOK-STACKED-CHARTS.md) use a separate
source-bound resolution path; this literal profile never authorizes reference
caches.
