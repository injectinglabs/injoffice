...
- `icon.png`: 1024 × 1024, also copied to `electron/icon.png` for the window icon.
- `icon.icns`: macOS 16–1024 pixel representations; electron-builder derives the
  Linux icon size set from this file when packaging.
