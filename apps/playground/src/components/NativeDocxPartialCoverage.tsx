...
export function NativeDocxPartialCoverage({coverage}:{coverage:NativeDocxPartialContentV1}){
 ...
 return <section aria-label="Read-only projection coverage">
  <p className="native-muted ds-muted">Preview coverage: {coverage.coverage.visited_body_blocks} of {coverage.coverage.body_blocks} body blocks inspected; {coverage.source_diagnostics.document.length} source diagnostics retained. This separate read-only inventory does not measure page layout or change the richer editor below.</p>
