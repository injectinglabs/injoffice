...
export type DemoGroup = 'AI-first' | 'Create and edit' | 'Workbook tools' | 'Production pipeline'
...
export const DEMOS: DemoDefinition[] = [
  { surface: 'sheets', title: 'Spreadsheets', navTitle: 'Spreadsheets', packageName: '@injoffice/sheets', description: 'Edit the sample workbook, explore workbook tools, or open and update an XLSX file in your browser.', runtime: 'Browser', group: 'Create and edit', tasks: ['Edit files', 'Analyze data', 'Review changes'], formats: ['XLSX'], keywords: ['workbook', 'cells', 'native mutation', 'download'], glyph: 'S', accent: 'mint', recipe: DEMO_RECIPES.sheets, ...sheets },
  { surface: 'docs', title: 'Documents', navTitle: 'Documents', packageName: '@injoffice/docs', description: 'Open a DOCX, select an editable passage, change its text, and download the updated file. The preview shows document content without exact page layout.', runtime: 'Browser', group: 'Create and edit', tasks: ['Edit files', 'Review changes'], formats: ['DOCX'], keywords: ['word', 'text', 'native mutation', 'download'], glyph: 'D', accent: 'blue', recipe: DEMO_RECIPES.docs, ...docs },
  ...
  { surface: 'pdf', title: 'PDF workbench', navTitle: 'PDF', packageName: '@injoffice/pdf', description: 'Open a PDF, highlight passages, draw on the page, fill forms, and organize pages. Undo changes as you explore, then download your edited file. Advanced server tools require local setup.', runtime: 'Browser', group: 'Create and edit', tasks: ['Edit files', 'Review changes', 'Ship workflows'], formats: ['PDF'], keywords: ['annotate', 'markup', 'forms', 'OCR', 'redact', 'stamp'], glyph: 'A', accent: 'violet', recipe: DEMO_RECIPES.pdf, ...pdf },
  ...
  { surface: 'agent', title: 'AI-first change sets', navTitle: 'AI change sets', packageName: '@injoffice/agent-tools', description: 'Any model can inspect, plan, preview, and verify a bounded Sheets, Docs, Slides, or PDF edit. The host keeps approval, commit, and original-file authority — no model SDK ships in this package.', runtime: 'Browser', group: 'AI-first', tasks: ['Edit files', 'Review changes', 'Ship workflows'], formats: ['XLSX', 'DOCX', 'PPTX', 'PDF'], keywords: ['AI', 'AI-first', 'agent', 'approval', 'change set', 'verification', 'tools', 'sheets', 'docs', 'slides', 'pdf', 'xlsx', 'docx', 'pptx'], glyph: 'AI', accent: 'blue', recipe: DEMO_RECIPES.agent, ...agent },
...
export const DEMO_GROUPS: DemoGroup[] = ['AI-first', 'Create and edit', 'Workbook tools', 'Production pipeline']
