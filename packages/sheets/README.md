...
revision, worksheet part and zero-based coordinates. Neither changes the workbook
or grants edit support. Overlapping tables, missing provenance and unsupported
